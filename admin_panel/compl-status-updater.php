...
$query="SELECT * from complaint_db where status!='Pending' AND status!='Rejected'";
...
<html>
<head>
    <title>Complaint Status Updater-Admin Panel</title>
    ...
    <section class="approval-section">
        <div class="container py-5">
            <div class="heading text-center py-5 mt-4">
                <h1>Complaint Status Updater</h1>
            </div>
            <table class="table table-striped approval-table  my-5">
                <thead class="thead-dark">
                  <tr>
                    ...
                    <th scope="col">Crime Categoery</th>
                ...
                <tbody>
                  <tr>
                    ...
                    <td><?php echo $ind['full_name']; ?></td>
                    <td><?php echo $ind['crime_category']; ?></td>
                    <td><?php echo $ind['crime_year']; ?></td>
                    <td><a href="update-status.php?c_id=<?php echo $ind['complaint_id']; ?>">View Details</a></td>
                  </tr>   
                </tbody>
                <?php } ?>
              </table>
