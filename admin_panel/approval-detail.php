...
if(isset($_POST["Approve"])) { 
  $query1="UPDATE complaint_db SET status='Approved' WHERE complaint_id='$complaintid'";
  if(mysqli_query($conn,$query1)){
    echo "<script>alert('Complaint Approved Successfully')</script>";
    header('Location:complaint-approval.php');
  }
  else{
...
elseif (isset($_POST["Reject"])) {
  $query2="UPDATE complaint_db SET status='Rejected' WHERE complaint_id='$complaintid'";
